...
# Note: nums1 is modified in-place, so we check nums1 after the call
TEST_CASES = [
...
# Special handling: this function modifies in-place and returns None
# The test runner checks nums1 (first argument) after the call
INPLACE_ARG_INDEX = 0
